...
test <- data[[1]]
print(head(test))
dism_pearson <- Output_SM(k_cpu = 8, data, method = "Pearson")  #k_cpu means the number of processors to be used
print("done_pearson")
dism_cosine  <- Output_SM(k_cpu = 8, data, method = "Cosine")
print("done_consine")
dism_hamming <- Output_SM(k_cpu = 8, data, method = "Hamming")
print("done_hamming")
