...
CpG_coordinates_per_chr_function <- function(region_coord,genome,type_C){
  ...
  for(i in 1:dim(region_coord)[1]){
    ...
    if (length(C_coords) == 0){
      ...
      C_coords_positions <- (C_coords-1) + region_coord$start[i]
#here originally is star[i]
    }
...
##originally BSgenome.Hsapiens.NCBI.GRCh38
if((args$genome_library == "BSgenome.Hsapiens.UCSC.hg19") | (args$genome_library == "BSgenome.Hsapiens.UCSC.hg38")){
...
#####debug
print("region_coord")
print(head(region_coord,n=10))
print("region_length")
print(head(region_length,n=10))
#####
...
#originally BSgenome.Hsapiens.UCSC.hg38 doesnt exist#
if( (args$genome_library == "BSgenome.Hsapiens.UCSC.hg19") | (args$genome_library == "BSgenome.Mmusculus.UCSC.mm10")  | (args$genome_library == "BSgenome.Hsapiens.UCSC.hg38") ){
...
print("here1")
##originally BSgenome.Hsapiens.NCBI.GRCh38
##originally here wasnt annotated

#if(args$genome_library == "BSgenome.Hsapiens.UCSC.hg38"){
